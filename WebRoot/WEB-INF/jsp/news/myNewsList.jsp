...
function ajaxSubmit(pageNum, title, startDate, endDate) {
		$.ajax({
			type : "post",
			url : '${pageContext.request.contextPath}/news/ajaxMyList.action',
			data : {
				pageNum : pageNum,
				title : title,
				startDate : startDate,
...
function searchDetail(id){
	...
	document.forms.newsFrom.action="${pageContext.request.contextPath}/news/newsDetail.action?id="+id+"&flag="+2;
	document.forms.newsFrom.submit();	
}
</script>
</head>
...
<div id="right">
	<div class="right_box">
		<div class="menu_div"><ul class="menu_title">当前位置： 我的新闻</ul></div>
	</div>
	<div id="contant">
