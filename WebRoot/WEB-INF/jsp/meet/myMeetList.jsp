...
function ajaxSubmit(pageNum, searchName, startDate, endDate) {
		$.ajax({
			type : "post",
			url : '${pageContext.request.contextPath}/meet/ajaxMyList.action',
			data : {
				pageNum : pageNum,
...
function toLook(id){
	 document.forms.meetFrom.action="${pageContext.request.contextPath}/meet/meetDetail.action?id="+id+"&tag="+2;
