...
function toSubmit(){
	if(jQuery.formValidator.pageIsValid("1")){
		document.forms.dingyiform.action="dingyi!update.action";
...
<body>
<div id="right">
<s:form action="dingyi!update.action" name="dingyiform"  validate="true" theme="simple" id="dingyiform" >
	<s:hidden name="id" id="id"/>
	<div class="right_box">
		<div class="menu_div"><ul class="menu_title">当前位置： 流程管理-表单修改</ul></div>
	</div>
		<div class="com_contant">
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0" class="data_list_b" summary="部门新增" id="intertable">
				...
				<tr>
					<th>表单名称</th>
					<td>
						 <s:textfield name="title" id="title" cssClass="text_318" maxlength="200"/>
					</td>
					<td style="border-left-style:none"> <div id="titleTip"/></td>
				</tr>
				 <s:iterator id='data' value='neirongList'>
					<tr>
						<th><s:property value="mingcheng"/><input type='hidden' name="wenbenvalue" id='reshipdateStr13' class='text_318' value="<s:property value="mingcheng"/>"/><input type='hidden' name="flagvalue" id='reshipdateStr12' class='text_318' value="<s:property value="leidanleixing"/>"/></th>
						...
						<td><input type='image' src='images/btn/btn_01.gif' alt='删除' onclick='delRow("intertable")' /></td>
					</tr>	
				</s:iterator>	
		  </table>
