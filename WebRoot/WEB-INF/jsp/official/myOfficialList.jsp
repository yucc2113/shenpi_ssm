...
function ajaxSubmit(pageNum, searchName, startDate, endDate) {
		$.ajax({
			type : "post",
			url : '${pageContext.request.contextPath}/official/ajaxMyList.action',
			data : {
				pageNum : pageNum,
...
function toLook(id){
	 document.forms.OfficialForm.action="${pageContext.request.contextPath}/official/detail.action?id="+id+"&tag="+2;
...
<div id="right">
	<div class="right_box">
		<div class="menu_div"><ul class="menu_title">当前位置： 我的公文</ul></div>
	</div>
	<div id="contant">
