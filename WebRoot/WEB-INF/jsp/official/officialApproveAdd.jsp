...
function toReturn(){
	document.forms.officialAddform.action="official!officialApprove.action";
	document.forms.officialAddform.submit();
}

function toApprove(states){
	var id = $('#id').val();
	if(states==2){
		ymPrompt.confirmInfo({title:'信息确认',message:'确认要通过吗？',handler: function(tp){
				if(tp=='ok'){
					document.forms.officialAddform.action="official!toApprove.action?states="+states+"&id="+id;
					document.forms.officialAddform.submit();
					return true;
				}else{
					return false;
		...
		ymPrompt.confirmInfo({title:'信息确认',message:'确认要不通过吗？',handler: function(tp){
				if(tp=='ok'){
					document.forms.officialAddform.action="official!toApprove.action?states="+states+"&id="+id;
					document.forms.officialAddform.submit();
					return true;
...
<div id="right">
	<div class="right_box">
		...
		<div class="com_contant">
			...
			<s:hidden id="approveidea" name="approveidea"/>
			<table width="91.5%" border="0" cellspacing="0" cellpadding="0" class="data_list_b">
				...
				<tr>
					...
					<td  style="border-right-style:none">
						<s:textfield name="filename" id="filename" style="width:460px"/>
				...
				<tr>
					...
					<th>文号:</th>
					<td  style="border-right-style:none">
						<s:textfield name="wenhao" id="wenhao" style="width:460px"/>
					</td>
					<td style="border-left-style:none">
        ...
        <div id="editmain_right" class="editmain_right">
		 ...
		 <%-- 
		  ...
		  <div class="project_21btn fl">
					<a href="#" onclick="toApprove(2);return false;"><img src="images/btn/btn_10.gif" alt="通过" /></a>
					&nbsp;&nbsp;
					<a href="#" onclick="toApprove(3);return false;"><img src="images/btn/btn_11.gif" alt="不通过" /></a>
					&nbsp;&nbsp;
