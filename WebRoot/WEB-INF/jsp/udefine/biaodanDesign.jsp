  ...
  alert("hi");
	...
	function toUpdate(){
		...
		if(hasContents==false){
			...
			document.forms.udForm.action="${pageContext.request.contextPath}/udefineBiaodan/designSave.action";
			document.forms.udForm.submit();
		}
	}
	
	function togetString(){
			document.forms.udForm.action="${pageContext.request.contextPath}/udefineBiaodan/biaodanList.action";
			document.forms.udForm.submit();
	}
...
<body>
<div id="right">
<form  name="udForm"  validate="true" theme="simple" id="udForm" method="post">
	...
	<table width="100%" class="TableBlock">
		<tr bgcolor="#ffffff">
			...
			<td width="95%" style=" text-align:left;">
				<div style="width:100%;">
				    <script id="editor" type="text/plain" style="width:920px;height:450px;">${udBiaodan.dcontent}</script>
				</div>
			</td>
		</tr>
	</table>
